  ...
  (function () {
    ...
    var View = (function () {
      function View() {
        ...
        this.inputTemplate = 
            '<div class="mdl-textfield mdl-js-textfield blue">\n<input class="mdl-textfield__input blue" type="text" id="todo-input">\n                         <label class="mdl-textfield__label blue" for="todo-input">Voy hacer...</label>\n                     </div>';
      }
      ...
      _createClass(View, [{
        ...
        value: function _prepareTemplate(data) {
          return '<span class = "mdl-list__item-primary-content blue">\n                        <label for="' + data.id + '" class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect mdl-checkbox--colored-light-blue mdl-js-ripple-effect--ignore-events is-upgraded" checkboxItem >\n                            <input type="checkbox" id="' + data.id + '" ' + data.completed + ' class="mdl-checkbox__input" />\n                            <span class="mdl-checkbox__label title-black">' + data.title + '</span>\n                        </label>\n                    </span>\n                    <div class="mdl-list__item-secondary-content">\n                        <button for = "' + data.id + '" class="mdl-button mdl-js-button mdl-button--icon mdl-button--colored--blue mdl-button--mini-icon pull-right" deleteItem>\n                            <i class="material-icons" style="color:blue;">clear</i>\n                        </button>\n                    </div>';
        }
      }, {
        key: 'showAll',
